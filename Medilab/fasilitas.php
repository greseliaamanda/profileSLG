...
<head>
  ...
  <title>Fasilitas - RSUD SLG</title>
    ...
    <section class="inner-page">
      <div class="container">
        ...
        ?>
            <div class="col">
                <div class="card">
                  <img src="../master/img/<?= $r_tampil_fasilitas['gambar']?>" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title"><?= $r_tampil_fasilitas['nm_fasilitas']?></h5>
                    <p class="card-text"><?= $r_tampil_fasilitas['deskripsi']?></p>
                  </div>
                </div>
            </div>
        <?php
