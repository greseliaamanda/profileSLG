...
<head>
    ...
    <title>RSUD SLG - Tambah Galeri</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-2">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Tambah Data Galeri</h1>
                            </div>
                            
                            <form action="action.php" method="POST" class="fasilitas" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="nama" name="deskripsi" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Deskrisi">
                                </div>
                                <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-primary btn-user btn-block" name="addGaleri" value="Submit">
                            </form>
                        </div>
                    </div>
                </div>
